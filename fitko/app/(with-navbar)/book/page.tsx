...
import {getAllUpcomingSessions, getAvailableClientSessions} from "@/lib/session";
...
export default async function BookPage() {
    ...
    const clientSessions=await getAvailableClientSessions(profile?.trainer_id,profile?.id)
