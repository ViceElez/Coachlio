        ...
        <div className="flex flex-wrap items-center justify-between gap-2 p-3 sm:p-4 rounded-xl border border-gray-100 hover:border-emerald-100 hover:bg-emerald-50/30 transition-colors">
            <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                    ...
                    <p className="text-xs text-amber-500 mt-0.5 truncate">{formatDate(session.sessions.start_time)}, {formatTime(session.sessions.start_time)}</p>
                </div>
            </div>
            <span
                className="text-xs font-semibold px-3 py-1 rounded-full shrink-0 bg-emerald-500 text-white"
            >
